	...
	<div class="py-12 bg-white">
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			<div class="grid sm:grid-cols-4 grid-cols-2 gap-4">
				<div>
					<h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">What we do</h2>
				...
				<div
					...
					<img class="rounded-t-lg" src="~/assets/img/global6500_interior.jpeg" alt="" />
					<div class="p-5">
						<a href="#">
				...
				<div
					class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
					<img class="rounded-t-lg" src="~/assets/img/7series_interior_cropped.jpg" alt="" />
					<div class="p-5">
						<a href="#">
