<template>
	<form class="mx-auto max-w-lg">
		<p class="font-medium mb-6">Send us a message</p>
		...
		<div class="flex flex-wrap -mx-3 mb-6">
			<div class="w-full px-3">
				...
				<textarea class=" no-resize appearance-none block w-full bg-transparent text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 h-48 resize-none" id="message"></textarea>
			</div>
		</div>
		<div class="md:flex md:items-center">
			<div class="md:w-1/3">
				<button class="shadow bg-jet-light hover:bg-jet-dark focus:shadow-outline focus:outline-none text-white font-medium py-2 px-4 rounded" type="button">
					Send
				</button>
			</div>
