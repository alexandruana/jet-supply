	...
	[1373],
	{
					...
					return (function (
						...
						for (
							...
							var e =
								...
								d =
									Z.emitUnicodeLocaleId(
										u.canonicalizeUnicodeLocaleId(
											r.parseUnicodeLocaleId(
												e
											)
										)
									)
				...
				Object.defineProperty(
					...
					'parseUnicodeLanguageId',
					{
						enumerable:
							!0,
						get: function () {
							return e.parseUnicodeLanguageId
						}
					}
				),
				Object.defineProperty(
					...
					'isStructurallyValidLanguageTag',
					{
						enumerable:
							!0,
						get: function () {
							return e.isStructurallyValidLanguageTag
						}
					}
				),
				Object.defineProperty(
					...
					'isUnicodeRegionSubtag',
					{
						enumerable:
							!0,
						get: function () {
							return e.isUnicodeRegionSubtag
						}
					}
				),
				Object.defineProperty(
					...
					'isUnicodeScriptSubtag',
					{
						enumerable:
							!0,
						get: function () {
							return e.isUnicodeScriptSubtag
						}
					}
				),
				Object.defineProperty(
					...
					'isUnicodeLanguageSubtag',
					{
						enumerable:
							!0,
						get: function () {
							return e.isUnicodeLanguageSubtag
						}
					}
				),
				L.__exportStar(
		...
		98781: function (
			...
			Object.defineProperty(
				...
				(n.emitUnicodeLocaleId =
					n.emitUnicodeLanguageId =
						void 0)
			var L =
				t(70655)
			function r(
		...
		8108: function (
			...
			function A(
				...
				if (!r)
					throw new RangeError(
						'Missing unicode_language_subtag'
					)
				if (
					'root' ===
					r
			...
			function M(
				...
				throw new RangeError(
					'Malformed transformed_extension'
				)
			}
			function f(
				a
				...
				throw new RangeError(
					'Malformed private_use_extension'
				)
			}
			function N(
				a
