							...
							(this._setReadStateCallbacksPromise =
								new Promise(
									function (
										...
										a._setReadStateCallbacksPromiseResolve =
											e
									}
								))
					}
					...
					return (
						...
						i.Z)(
							...
							[
																...
																for (;;)
																	switch (
																		...
																		case 0:
																			...
																			return (
																				(e.next = 4),
																				this._initializeFormFieldValues()
																			)
																		case 4:
																			return e.abrupt(
																				'return',
																...
																for (;;)
																	switch (
																		...
																		case 0:
																			if (
																				(this._verifyLoaded(),
																				!this.state.alreadyLoadedPages.has(
																					t
																				))
																			) {
																				e.next = 5
																			...
																			return (
																				(e.next = 4),
																				this.state.alreadyLoadedPages.get(
																					t
																				)
																			)
																		case 4:
																		...
																		case 10:
																			;(n =
																				...
																				(r =
																					...
																					this.bookmarkCallbacks.createBookmarks(
																						r,
																						P.y
																					)),
																				(e.next = 20)
								...
								{
									key: '_initializeFormFieldValues',
									value:
										((t =
											(0,
											o.Z)(
																								...
																								function (
																									...
																									try {
																										...
																										return (
																											(0,
																											f.um)(
																												'Skipped form field value '.concat(
																													t.name,
																													' from payload because an error occurred while deserializing.'
																												),
																												t
